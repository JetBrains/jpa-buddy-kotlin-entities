...
open class Project {
    ...
    /**
     * There are two options how to deal with equals() and hashCode() for JPA entities with generated ids:
     * 1. Not implement them at all and rely on the Object implementations.
     * 2. Use only the id in equals() and return a constant from hashCode()
     * Read more: https://thorben-janssen.com/ultimate-guide-to-implementing-equals-and-hashcode-with-hibernate/
     */
